<template>
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <q-card-section>
            <div class="text-h6">Adicionar Auto de Perguntas!</div>
        </q-card-section>
               <q-card-section>
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
                <q-form @submit.prevent="createPergunta" class="q-gutter-md">
                    <q-list>
                    <q-item>
                        <div class="row">                
        ...
        <div class="row q-gutter-xs" style="width: 500px;">
          <div class="col-4 text-left">Interrogatório *</div>
                                 <q-input outlined tack-label class="w-field" :dense="true" :value="interrogatorio"  type="textarea"   @input="$emit('update:interrogatorio', $event)"/>
        </div>
                         </div>
                    </q-item>
                    <q-item>
        ...
        <q-card-actions align="right">
            <q-btn type="submit" :loading="submitting" @click.stop="createPergunta" color="teal" label="Gravar" />
