    ...
    allData () {
      ...
      for (let processo of this.allProcessos){
        ...
        data.push(
          ...
          'Orgão': (processo.orgao !== null) ? Orgao.query().find(processo.orgao_id).designacao : ' ', 
          'Jurisdição': (processo.classeJudicial_id !== null) ? ClasseJudicial.query().find(processo.classeJudicial_id).designacao : ' ',
          'Acções-Crimes': (processo.accoesCrimes_id !== null) ? Crime.query().find(processo.accoesCrimes_id).designacao : ' ',
