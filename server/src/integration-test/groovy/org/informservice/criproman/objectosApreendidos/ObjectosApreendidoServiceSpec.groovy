...
@Integration
@Rollback
class ObjectosApreendidoServiceSpec extends Specification {
    ...
    void "test list"() {
        ...
        when:
        List<ObjectosApreendido> objectosApreendidosList = objectosApreendidosService.list(max: 2, offset: 2)
    ...
    void "test save"() {
        ...
        ObjectosApreendido objectosApreendidos = new ObjectosApreendido()
