...
@Integration
@Rollback
class ObjectoDetidoServiceSpec extends Specification {
    ...
    void "test list"() {
        ...
        when:
        List<ObjectoDetido> objectosDetidoList = objectosDetidoService.list(max: 2, offset: 2)
    ...
    void "test save"() {
        ...
        ObjectoDetido objectosDetido = new ObjectoDetido()
