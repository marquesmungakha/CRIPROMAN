    ...
    removeDenunciante(denunciante) {
      this.$q.dialog({
        ...
        this.$q.notify({
         ...
         PecaProcessoDenunciante.api().delete("/pecaProcessoDenunciante/" + this.pecaProcessoDenunciante.id)
         PecaProcessoDenunciante.delete(this.pecaProcessoDenunciante.id)
      })
    },
   ...
   getAllTipoDocumentoIdentificacao(offset) {
    ...
    exportTable() {
      ...
      const content = [this.columns.map(col => wrapCsvValue(col.label))]
        .concat(
          this.allDenunciantesFromPecaProcesso.map(row =>
            this.columns
              .map(col =>
                wrapCsvValue(
