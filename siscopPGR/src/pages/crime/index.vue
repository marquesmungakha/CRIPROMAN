<template>
  <q-page class="q-pa-sm q-gutter-sm">
    <q-table :columns="columns" :data="allCrimes" :filter="filter" binary-state-sort row-key="name" title="Ações/Tipos Legais de Crime">
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          name: 'classeJudicial',
          align: 'left',
          label: 'Jurisdição/Família Delitiva',
