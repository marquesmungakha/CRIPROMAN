      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <q-card>
          <q-tabs
            ...
            narrow-indicator>
            <q-tab label="Ações/Tipos Legais de Crime" name="crimes"/>
          </q-tabs>
...
export default {
  ...
  i18n: {
    messages: {
      pt: {
        title: 'Detalhes da Jurisdição/Famílias Delitivas',
        basicInformation: 'Informacção da Jurisdição/Famílias Delitivas',
