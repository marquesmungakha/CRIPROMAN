  ...
  <div class="q-pa-sm q-gutter-sm">
    <q-dialog v-model="show_dialog" persistent>
      <q-card style="width: 600px; max-width: 60vw;">
        <q-card-section>
          <div class="text-h6">Adicionar Pais!</div>
        </q-card-section>
        <q-card-section>
        ...
        <div class="row q-gutter-xs" style="width: 500px;">
          <div class="col-4 text-left">Código *</div>
                  <q-input outlined tack-label class="w-field" :dense="true" :value="codigo"
                           ...
                           lazy-rules
                           :rules="[ val => val && val.length > 0 || 'Introduza o codigo do Pais']"/>
        </div>            
        <div class="row q-gutter-xs" style="width: 500px;">
        ...
        <div class="row q-gutter-xs" style="width: 500px;">
          <div class="col-4 text-left">Nacionalidade *</div>
                  <q-input outlined tack-label class="w-field" :dense="true" :value="nacionalidade"
                           @input="$emit('update:nacionalidade', $event)"
                           ref="nacionalidade"
                           
                           lazy-rules
                           :rules="[ val => val && val.length > 0 || 'Introduza a Nacionalidade']"/>
        </div>
              </div>
            </q-list>
          </q-form>
        ...
        <q-card-actions align="right">
          <q-btn type="submit" :loading="submitting" @click.stop="createPais" color="teal" label="Gravar"/>
