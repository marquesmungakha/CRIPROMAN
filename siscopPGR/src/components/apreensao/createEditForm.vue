<template>
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <q-card-section>
            <div class="text-h6">Adicionar Auto de Apreensão!</div>
        </q-card-section>
               <q-card-section>
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
                <q-form @submit.prevent="createApreensao" class="q-gutter-md">
                    <q-list>
                    <q-item>
                       <div class="row">
        ...
        <div class="row q-gutter-xs" style="width: 500px;">
          <div class="col-4 text-left">Descrição do Local de Apreensão *</div>
                                 <q-input outlined tack-label class="w-field" :dense="true" :value="localApreencao"  type="textarea"   @input="$emit('update:localApreencao', $event)"/>
        </div>
        </div>
                    </q-item>
                    <q-item>
        ...
        <q-card-actions align="right">
            <q-btn type="submit" :loading="submitting" @click.stop="createApreensao" color="teal" label="Gravar" />
