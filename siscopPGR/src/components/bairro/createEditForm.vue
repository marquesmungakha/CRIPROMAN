<template>
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <div class="row q-gutter-xs" style="width: 500px;">
          <div class="col-4 text-left">Posto Administrativo </div>
                            <q-select
                              filled
                              outlined tack-label class="w-field" :dense="true" :value="postoAdministrativo"
                              use-input
                              fill-input
                              hide-selected
                        ...
                        <div class="row">                
        <div class="row q-gutter-xs" style="width: 500px;">
          <div class="col-4 text-left">Localidade</div>
                            <q-select
                              filled
                              outlined tack-label class="w-field" :dense="true" :value="localidade"
                              use-input
                              fill-input
                              hide-selected
