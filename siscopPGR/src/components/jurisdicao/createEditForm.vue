<template>
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <q-card-section>
            <div class="text-h6">Adicionar  Jurisdição/Família Delitiva!</div>
        </q-card-section>
                <q-card-section>
        ...
        <div class="row q-gutter-xs" style="width: 500px;">
          <div class="col-4 text-left">Designaçãoo *</div>
        ...
        <q-card-actions align="right">
            <q-btn type="submit" :loading="submitting" @click.stop="createJurisdicao" color="teal" label="Gravar" />
