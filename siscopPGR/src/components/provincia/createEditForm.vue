<template>
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <q-card-section>
            <div class="text-h6">Adicionar  Província!</div>
        </q-card-section>
          <q-card-section>
        ...
        <div class="row q-gutter-xs" style="width: 500px;">
          <div class="col-4 text-left">Código *</div>
                                ...
                                lazy-rules
                                :rules="[ val => val && val.length > 0 || 'Introduza o codigo da Província']" />
        </div> 
        <div class="row q-gutter-xs" style="width: 500px;">
        ...
        <q-card-actions align="right">
            <q-btn type="submit" :loading="submitting" @click.stop="createProvincia" color="teal" label="Gravar" />
