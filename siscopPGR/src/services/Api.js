...
instance.interceptors.response.use(function (response) {
  ...
  if (error.response.status === 401 && !originalRequest._retry) {
    ...
    console.log('attempt to refresh token here -' + 'http://192.168.1.127:8080/oauth/access_token?grant_type=refresh_token&refresh_token=' + rToken);
    ...
    return axios.post('http://192.168.1.127:8080/oauth/access_token?grant_type=refresh_token&refresh_token=' + rToken)
      .then(({data}) => {
