...
import ObjectoDetido from "../objectoDetido/objectoDetido";

export default class Detido extends Model {

  static  entity = 'detidos'
  ...
  static fields() {
    return {
      ...
      objectosDetido: this.hasMany(ObjectoDetido, "detido_id")
