<template>
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <q-card-section>
            <div class="text-h6">Adicionar  Posto Administrativo!</div>
        </q-card-section>
            <q-card-section>
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
                <q-form @submit.prevent="createPostoAdministrativo" class="q-gutter-md">
                    <q-list>
                        <q-item>
                            <q-item-section>
                                ...
                                label="Código *"
                                lazy-rules
                                :rules="[ val => val && val.length > 0 || 'Introduza o codigo da PostoAdministrativo']" />
                            </q-item-section>
                        </q-item>
                        <q-item>
                            <q-item-section>
        ...
        <q-card-actions align="right">
            <q-btn type="submit" :loading="submitting" @click.stop="createPostoAdministrativo" color="teal" label="Gravar" />
