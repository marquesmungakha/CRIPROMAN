<template>
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <q-card-section>
            <div class="text-h6">Adicionar Auto de Corpo de Delito Indirecto!</div>
        </q-card-section>
            <q-card-section>
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
                <q-form @submit.prevent="createCorpoDelito" class="q-gutter-md">
                    <q-list>
                        <q-item>
                            <q-item-section>
        ...
        <q-card-actions align="right">
            <q-btn type="submit" :loading="submitting" @click.stop="createCorpoDelito" color="teal" label="Gravar" />
