<template>
  <q-page class="q-pa-sm q-gutter-sm">
    <q-table :columns="columns" :data="allDeclarantesFromPecaProcesso" :filter="filter" binary-state-sort
...
import PecaProcessoDeclarante from 'src/store/models/pecaProcesso/pecaProcessoDeclarante'
...
export default {
  ...
  metaInfo: {},
  computed: {
    allDeclarantesFromPecaProcesso() {
      return PecaProcesso.query().with('declarantes')
                                 ...
                                 .find(this.pecaProcesso.id).declarantes
    },
    allPaises() {
 ...
 //     }, 300)
      ...
      this.declarante.pecaProcesso_id = this.pecaProcesso.id
      ...
      this.declarante.pecaProcesso = this.pecaProcesso

      this.pecaProcessoDeclarante.declarante =  this.declarante
      this.pecaProcessoDeclarante.pecaProcesso = this.pecaProcesso
     
     console.log(this.pecaProcessoDeclarante)

      if (this.editedIndex > -1) {
         PecaProcessoDeclarante.api().patch("/pecaProcessoDeclarante/" + this.pecaProcessoDeclarante.id, this.pecaProcessoDeclarante).then(resp => {
        this.submitting = false
          this.$q.notify({
            type: 'positive',
            color: 'green-4',
            ...
            classes: 'glossy',
            progress: true,
            message: 'A informação foi actualizada com successo!! [' + this.pecaProcessoDeclarante.declarante.nome + ' ]'
          })
          this.close()
        }).catch(error => {
        ...
        PecaProcessoDeclarante.api().post("/pecaProcessoDeclarante/", this.pecaProcessoDeclarante).then(resp => {
        this.submitting = false
          console.log(resp)
          this.$q.notify({
            type: 'positive',
            ...
            classes: 'glossy',
            progress: true,
            message: 'A informação foi inserida com successo! [ ' + this.pecaProcessoDeclarante.declarante.nome + ' ]'
          })
          this.close()
        }).catch(error => {
          console.log('Erro no code ' + error)
    ...
    removeDeclarante(declarante) {
      this.$q.dialog({
        ...
        this.$q.notify({
         ...
         PecaProcessoDeclarante.api().delete("/pecaProcessoDeclarante/" + this.pecaProcessoDeclarante.id)
         PecaProcessoDeclarante.delete(this.pecaProcessoDeclarante.id)
      })
    },
