    ...
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <q-card-section style="max-height: 50vh" class="scroll">
                <q-form @submit.prevent="createDespacho" class="q-gutter-md">
                    <q-list>
                         <q-item>
                            <q-item-section>
                            ...
                            <q-item>
                            <q-item-section>
                                 <q-input :value="parecer"  type="textarea"  label="Descrição do Parecer do Despacho  " @input="$emit('update:parecer', $event)"/>
                            </q-item-section>
                        </q-item>
                         <q-item>
                            <q-item-section>
        ...
        <q-card-actions align="right">
            <q-btn type="submit" :loading="submitting" @click.stop="createDespacho" color="teal" label="Gravar" />
