<template>
    <div class="q-pa-sm q-gutter-sm">
       <q-dialog v-model="show_dialog" persistent>
        ...
        <q-card-section>
            <div class="text-h6">Adicionar  Tipo Auto!</div>
        </q-card-section>
               <q-card-section>
                    ...
                    <q-list>
                        <q-item>
                            <q-item-section>
                                ...
                                label="Codigo *"
                                lazy-rules
                                :rules="[ val => val && val.length > 0 || 'Introduza o código do Tipo de Auto']" />
                            </q-item-section>
                        </q-item>
                        <q-item>
                            <q-item-section>
        ...
        <q-card-actions align="right">
            <q-btn type="submit" :loading="submitting" @click.stop="createTipoAuto" color="teal" label="Gravar" />
