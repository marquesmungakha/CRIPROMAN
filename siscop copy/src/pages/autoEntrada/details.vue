        ...
        <q-card-section class="bg-white text-grey">
          ...
          <div class="row">
            ...
            <div class="col">
              <q-item class="full-width">
                <q-item-section>
                  <q-item-label caption lines="1">{{ $t('modusOperandi') }}</q-item-label>
          ...
          <div class="row">
            <div class="col">
              <q-item class="full-width">
                <q-item-section>
                  <q-item-label caption lines="1">{{ $t('horaOcorrencia') }}</q-item-label>
            ...
            <div class="col">
              <q-item class="full-width">
                <q-item-section>
                  <q-item-label caption lines="1">{{ $t('infraccao') }}</q-item-label>
          ...
          <div class="row">
            <div class="col">
              <q-item class="full-width">
                <q-item-section>
                  <q-item-label caption lines="1">{{ $t('endereco') }}</q-item-label>
            ...
            <div class="col">
              <q-item class="full-width">
                <q-item-section>
                  <q-item-label caption lines="1">{{ $t('responsavelLocal') }}</q-item-label>
          ...
          <div class="row">
            ...
            <div class="col">
              <q-item class="full-width">
                <q-item-section>
                  <q-item-label caption lines="1">{{ $t('tipoAuto') }}</q-item-label>
          ...
          <div class="row">
            <div class="col">
              <q-item class="full-width">
                <q-item-section>
                  <q-item-label caption lines="1">{{ $t('familiaDelitiva') }}</q-item-label>
            ...
            <div class="col">
              <q-item class="full-width">
                <q-item-section>
                  <q-item-label caption lines="1">{{ $t('tipoLegalCrime') }}</q-item-label>
      ...
      <q-card>
        ...
        <q-tab-panels v-model="tab1" animated transition-prev="scale"  transition-next="scale">
          ...
          <q-tab-panel name="meiosUtilizados">
            <list-meiosUtilizados :pecaProcesso.sync="pecaProcesso"/>
          </q-tab-panel>
          <q-tab-panel name="bensSubtraidos">
            <list-bensSubtraidos :pecaProcesso.sync="pecaProcesso"/>
          </q-tab-panel>
...
export default {
  ...
  preFetch({store, currentRoute, previousRoute, redirect, ssrContext, urlPath, publicPath}) {
    ...
    // Example:
    return AutoEntrada.query().with('orgao').with('inspector').with('crime').with('classeJudicial').with('tipoAuto').find(currentRoute.params.id)
  },
  created() {
  },
  mounted() {
  ...
  computed: {
    autoEntrada: {
      get() {
        return AutoEntrada.query().with('orgao').with('inspector').with('crime').with('classeJudicial').with('tipoAuto').find(this.$route.params.id)
      },
      set(autoEntrada) {
